...
const AddEditCustomer = () => {
      ...
      const fetchCustomerDetails = async () => {
        try {
          ...
          if (response.data && response.data.success) {
            ...
            setFormData({
              ...data,
              guarantor1: data.guarantor1 || { name: '', fatherName: '', mobileNumber: '', cnic: '', relation: '', address: '' },
              guarantor2: data.guarantor2 || { name: '', fatherName: '', mobileNumber: '', cnic: '', relation: '', address: '' }
            });
          }
        } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(error.response?.data?.message || 'Failed to submit customer credentials.');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (fetching) {
    return (
      <div className="flex flex-col items-center justify-center p-12 space-y-3">
        ...
        <span className="text-gray-500 text-sm font-bold">Querying profiles database...</span>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900">{isEditMode ? 'Modify Customer Profile' : 'Register New Buyer & Guarantors'}</h2>
          <p className="text-sm text-gray-600">Enter customer identity and up to 2 Zamanatdaar (Zamanti) details for safe financing.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 space-y-6">
          <h3 className="font-bold text-gray-800 border-b pb-2 text-base">Asal Customer ki Information</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold uppercase text-gray-500">Father's Name</label>
                <input
                  type="text"
                  name="fatherName"
              ...
              <div>
                <label className="block text-xs font-semibold uppercase text-gray-500">CNIC (National ID Card)</label>
                <input
                  type="text"
                  name="cnic"
                  value={formData.cnic}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase text-gray-500">Alt Phone (Optional)</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-xs font-semibold uppercase text-gray-500">Home Address</label>
                <input
                  type="text"
                  name="address"
              ...
              <div>
                <label className="block text-xs font-semibold uppercase text-gray-500">City</label>
                <input
                  type="text"
                  name="city"
                  value={formData.city}
        ...
        <div className="bg-white border border-purple-200 rounded-2xl shadow-sm p-6 space-y-4">
          <div className="border-b border-purple-100 pb-2 flex items-center justify-between">
            ...
            <span className="text-[10px] font-bold text-purple-600 bg-purple-50 px-2.5 py-0.5 rounded-full">Primary Guarantor</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-bold text-gray-600">
            <div>
              <label className="block text-gray-400 uppercase">Zamanti 1 Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">Father Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">Mobile Number</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">CNIC Number</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">Customer Se Rishta (Relation)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">Zamanti 1 Pata (Address)</label>
              <input
                type="text"
        ...
        <div className="bg-white border border-indigo-200 rounded-2xl shadow-sm p-6 space-y-4">
          <div className="border-b border-indigo-100 pb-2 flex items-center justify-between">
            ...
            <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2.5 py-0.5 rounded-full">Secondary Guarantor</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-bold text-gray-600">
            <div>
              <label className="block text-gray-400 uppercase">Zamanti 2 Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 uppercase">Zamanti 2 Pata (Address)</label>
              <input
                type="text"
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <span>{isEditMode ? 'Update Profile & Guarantors' : 'Save Customer & 2 Zamanti'}</span>
              </>
            )}
          </button>
        </div>

...
const YearlyAuditDetail = () => {
  ...
  if (!audit) {
    return (
      <p className="text-center p-10 text-red-600 font-bold">
        Register sheet lost.
      </p>
    );
  }
    ...
    <div className="space-y-8 max-w-7xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <span className="text-xs font-bold text-gray-400 uppercase tracking-wider block">
            Investment (Stock Bought Cost)
          </span>

          <p className="text-2xl font-black text-slate-900 mt-1">
            {settings.currency}{' '}
            {(audit.totalInventoryCost || 0).toLocaleString()}
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-2xl font-black text-green-700 mt-1">
            {settings.currency}{' '}
            {(audit.totalSalesRevenue || 0).toLocaleString()}
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-2xl font-black text-indigo-600 mt-1">
            {settings.currency}{' '}
            {(audit.totalYearlyProfit || 0).toLocaleString()}
          </p>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 space-y-6">
        ...
        <form
          ...
          className="grid grid-cols-1 md:grid-cols-5 gap-4 text-xs font-bold bg-slate-50 p-4 rounded-xl border border-slate-100"
        >
          <div>
            <label className="block text-gray-500 uppercase tracking-wider">
              Product Name
            </label>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 space-y-6">
        ...
        <form
          ...
          className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs font-bold bg-slate-50 p-5 rounded-xl border border-slate-100"
        >
          <div>
            <label className="block text-gray-500 uppercase tracking-wider">
              Product Name
          ...
          <div>
            <label className="block text-gray-500 uppercase tracking-wider">
              Buying Cost Price ({settings.currency})
            </label>
          ...
          <div>
            <label className="block text-gray-500 uppercase tracking-wider">
              Final Selling Price ({settings.currency})
            </label>
          ...
          'Installment' ? (
            <>
              <div>
                <label className="block text-purple-700 uppercase tracking-wider">
            ...
            <div className="md:col-span-3">
              <label className="block text-gray-400 uppercase tracking-wider">
                Actual Received Amount (Cash)
              </label>

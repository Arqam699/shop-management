...
const Customers = () => {
    ...
    if (
      ...
      try {
        ...
        setCustomers((prevCustomers) =>
          prevCustomers.filter((c) => c._id !== id)
        );
  ...
  const filteredCustomers = customers.filter((customer) => {
    ...
    const cnic = String(customer?.cnic || '').toLowerCase();
    ...
    const matchesDate = isDateInFilter(customer?.createdAt);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 font-medium">
            Register new buyers, track registration dates, and manage credit
            records.
          </p>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div className="p-10 text-center text-gray-500 flex flex-col items-center justify-center space-y-2">
            ...
            <p className="text-xs">
              Try switching date filters to "All-Time" or click "Register
              Customer".
            </p>
          </div>
        ) : (

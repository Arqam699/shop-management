...
const EditSale = lazy(
  () => import('./pages/EditSale')
);

const Installments = lazy(
  () => import('./pages/Installments')
);

const InstallmentPlanDetails = lazy(
  () => import('./pages/InstallmentPlanDetails')
);
...
const YearlyAudits = lazy(
  () => import('./pages/YearlyAudits')
);

const YearlyAuditDetail = lazy(
  () => import('./pages/YearlyAuditDetail')
);
          ...
          >
            ...
            <Routes>
              ...
              {/* =====================================================
                  ...
                  A logged-in admin with:
                  admin.mustChangePassword === true

                  can access this page.

                  ProtectedRoute will block all other protected
                  pages until the password is changed.
                  ===================================================== */}

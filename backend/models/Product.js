...
const productSchema = new mongoose.Schema(

  {
    ...
    category: {
      type: String,
      required: true,
      enum: ['Mobile Phones', 'LED TVs', 'Refrigerators', 'Washing Machines', 'Air Conditioners', 'Laptops', 'Accessories', 'Speakers', 'Motorbikes', 'Other']
    },
    ...
    sku: { type: String }, // Auto-generated e.g. PROD-0001

    serialNumber: { type: String, trim: true },

    imei: { type: String, trim: true }, // Optional for Mobiles
    chassisNumber: { type: String, trim: true }, // Required for Motorbikes
